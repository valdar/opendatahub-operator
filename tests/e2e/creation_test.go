...
func (tc *DSCTestCtx) ValidateDSCICreation(t *testing.T) {
	...
	tc.EnsureResourceCreatedOrUpdated(
		...
		WithEventuallyTimeout(tc.TestTimeouts.eventuallyTimeoutLong),
		WithEventuallyPollingInterval(gomegaEventuallyPollInterval),
	)
}
...
func (tc *DSCTestCtx) ValidateDSCCreation(t *testing.T) {
	...
	tc.EnsureResourceCreatedOrUpdated(
		...
		WithEventuallyTimeout(tc.TestTimeouts.eventuallyTimeoutMedium),
		WithEventuallyPollingInterval(gomegaEventuallyPollInterval),
	)
}
